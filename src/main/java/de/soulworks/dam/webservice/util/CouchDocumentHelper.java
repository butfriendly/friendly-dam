...
public class CouchDocumentHelper implements DocumentPropertyHandler {
	private static final Logger log = LoggerFactory.getLogger(CouchDocumentHelper.class);

	public CouchDocumentHelper() {
		log.info("Init CDH");
	}
